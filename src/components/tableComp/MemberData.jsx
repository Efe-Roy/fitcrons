...
const MemberData = ({memData}) => {
    ...
    const showModal3 = () => {
        ...
        setValue3("email", memData?.email)
        setValue3("phone", memData?.phone)
                            ...
                            <tbody>
                                ...
                                <tr className="border-b dark:border-neutral-500">
                                    ...
                                    <td className="whitespace-nowrap px-6 py-4">
                                            <>
                                                <button disabled={memData?.email? false : true} onClick={showModal3} className="mx-1 rounded-lg px-10 font-medium text-white py-2.5 whitespace-nowrap bg-amber-500">Edit Data</button>
                                                <button className="mx-1 rounded-lg px-10 font-medium text-white py-2.5 whitespace-nowrap bg-red-500">Delete Data</button>
                                            </>
                                        {/* {memData.role === "member"? null:
                                        } */}
                                    </td>
                                </tr>
                            </tbody>
